...
public class Deposite_Fragment_viewModel extends ViewModel {
   ...
   RetrofitInterface retrofitInterface;
    ...
    public LiveData<Walletlist> getWalletList(MainActivity activity, DepositeFragmentBinding binding){
