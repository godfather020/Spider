...
public class Id_Detail_Fragment_viewModel extends ViewModel {

    private String TAG ="Home_Fragment_viewModel";
   private MutableLiveData<List<Websitedetail>> userDetail=new MutableLiveData<>();
   ...
   RetrofitInterface retrofitInterface;
    ...
    public LiveData<List<Websitedetail>> getMyIdList(MainActivity activity, IdDetailFragmentBinding binding, String id){
        ...
        call.enqueue(new Callback<com.example.spider.model.Response>() {
            ...
            public void onResponse(Call<com.example.spider.model.Response> call, Response<com.example.spider.model.Response> response) {
                ...
                if(response.body().getMsgCode()==1){
                    userDetail.setValue(response.body().getWebsitedetail());
                }else {
