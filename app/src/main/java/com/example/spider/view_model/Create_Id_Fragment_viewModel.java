...
public class Create_Id_Fragment_viewModel extends ViewModel {
   ...
   RetrofitInterface retrofitInterface;
    ...
    public LiveData<Walletlist> getWalletList(MainActivity activity, CreateIdFragmentBinding binding){
...
//            userDetail.setValue(detail);
    ...
    public MutableLiveData<String> userCreateId(MainActivity activity, CreateIdFragmentBinding binding, String userName, String userId
...
//                Log.e("loginResponse","error=== "+t.getMessage().toString());
    ...
    public void  createId(RequestBody param){
        ...
        Call<com.example.spider.model.Response> call =retrofitInterface.createId(param);
