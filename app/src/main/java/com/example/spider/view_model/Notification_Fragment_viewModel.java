...
public class Notification_Fragment_viewModel extends ViewModel {
   ...
   RetrofitInterface retrofitInterface;
    ...
    public LiveData<List<Transactionhistory>> getNotiList(MainActivity activity, NotificationFragmentBinding binding){
