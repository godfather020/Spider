...
public class Withdraw_Fragment_viewModel extends ViewModel {
   ...
   RetrofitInterface retrofitInterface;
    ...
    public LiveData<Walletlist> getWalletList(MainActivity activity, WithdrawFragmentBinding binding){
